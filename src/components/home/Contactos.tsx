        ...
        <div className="row justify-center">
          <div className="w-full lg:w-2/3">
            <div className="flex flex-col justify-center">
              <a className="text-md mx-auto mb-2 flex" href="tel:+56973319401">
              ...
              <a
                className="text-md mx-auto mb-4 flex"
                href="mailto:ventas@zenova.cl"
              >
                <span className="material-symbols-outlined mr-1 mt-1 block">
                  email
                </span>
              ...
              <p className="text-md mx-auto mb-6 flex text-center text-gray-600">
